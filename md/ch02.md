...
<center>图2-1 提供计算最大公约数功能的web页面</center>
...
<center>图2-2 显示计算GCD结果的web页面</center>
...
<center>图2-4 复数平面和图片像素的关系</center>
...
<center>图2-5 将vector用作矩形像素数组</center>
...
<center>图2-7 把像素缓冲区分成若干条带来并行渲染</center>
