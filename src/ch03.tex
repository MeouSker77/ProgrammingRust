...
类型是Rust的一个核心部分。我们将在整本书中继续讨论类型并介绍新的类型。特别是，Rust 的用户定义类型赋予了语言很多自身的风格。有三种用户自定义的类型，我们将分别在三章中介绍它们：\hyperref[ch09]{第9章}介绍结构体，\hyperref[ch10]{第10章}介绍美枚举，\hyperref[ch11]{第11章}介绍trait。
